...
argparse::ArgumentParser parse_args(const size_t & argc, const char ** & argv) {
    ...
    std::cout << '\n';
    argparse::ArgumentParser parser("Dual avoided crossing - Tully 2nd model by global flux surface hopping");
...
int main(size_t argc, const char ** argv) {
    std::cout << "Dual avoided crossing - Tully 2nd model by global flux surface hopping\n"
              << "Yifan Shen 2021\n\n";
