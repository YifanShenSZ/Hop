...
argparse::ArgumentParser parse_args(const size_t & argc, const char ** & argv) {
    ...
    std::cout << '\n';
    argparse::ArgumentParser parser("Simple avoided crossing - Tully 1st model by global flux surface hopping");
...
int main(size_t argc, const char ** argv) {
    std::cout << "Simple avoided crossing - Tully 1st model by global flux surface hopping\n"
              << "Yifan Shen 2021\n\n";
